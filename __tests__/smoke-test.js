...
describe('"real life" smoke tests', function () {
  ...
  test('😭', function () {
    let template = `<a.fancy.component @aProp="a-path-to-an-svg-file-longer-than-80-chars.svg" />`;
    // this would be the replacement generated by Prettier
    let replacement = `<a.fancy.component
  @aProp="a-path-to-an-svg-file-longer-than-80-chars.svg"
/>`;
